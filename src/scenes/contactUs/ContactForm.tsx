				...
				>
					...
					<div className='hover:translate-y-0.7 group mx-auto mb-12 mt-16 w-full shadow-lg transition duration-500 sm:mb-24 sm:w-[45%]'>
						<input
							...
							className='flex h-full w-full cursor-pointer items-center justify-center rounded-md bg-banana-yellow-50 px-8 py-3 font-title-serif text-xl text-sun-300 transition duration-500 active:scale-95 group-hover:translate-y-0.5 group-hover:bg-sun-300  group-hover:text-banana-yellow-50 md:px-6 md:py-3'
						/>
					</div>
				</form>
			</div>
